...
export default function EditProject({ params }) {
    ...
    const fetchProject = async () => {
        try {
            ...
            console.log(`[DEBUG] Fetching project ${id} from ${apiUrl}`);
    ...
    return (
        <div className="admin-dashboard">
            <header className="dashboard-header">
                ...
                <h1>ADMIN_CMD : <span className="neon-text">EDIT_PROJECT</span></h1>
            ...
            <form id="edit-project-form" onSubmit={handleSubmit} className="admin-form">
                <div className="form-section hud-glass">
                    ...
                    <SocialPreview
                        ...
                        description={locale === 'fr' ? formData.descriptionFr : formData.descriptionEn}
